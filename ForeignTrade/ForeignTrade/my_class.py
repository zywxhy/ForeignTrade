...
# model增删改查类,配合layui数据模式
class ModelCRUD(View):
    def __init__(self,model,form,error_list,template,operation,sub_model1=None,sub_model2=None,*args,**kwargs):
        self.operation =operation    # create update Retrieve delete
        self.model = model
        self.form = form
    ...
    #
    # @staticmethod
    # def create(request, form, model, sub_model1=None, sub_model2=None,):
    #     if form.is_valid():
