...
class SalesForm(forms.Form):
    ...
    client = forms.ModelChoiceField(queryset=Client.objects.all(),widget=forms.Select(attrs={'class': 'form-control selectpicker select2_sample','data-live-search':'true'}),label='客户')
    ...
    export_company = forms.CharField(max_length=20,label='出口公司',widget=forms.TextInput(attrs={'class': 'form-control'}))
