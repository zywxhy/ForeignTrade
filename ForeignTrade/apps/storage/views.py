...
class StorageAddView(View):
    def get(self,request):
        ...
        purchase = PurchaseContract.objects.get_object_or_404(purchase_num =purchase_num)
        purchase_id = purchase.id
        product_list = PurchaseProduct.objects.filter(purchase_id=purchase_id, count__gt=F('storage_count'))
