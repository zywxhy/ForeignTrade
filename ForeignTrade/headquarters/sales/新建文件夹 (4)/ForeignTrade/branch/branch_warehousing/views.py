...
class BranchWarehousingViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # if existed:
        #     existed.update(domestic_invoice=domestic_invoice,**data)
        #     warehousing = existed[0]
        #     warehousing.warehousing_product.all().delete()
        # else:
        #     warehousing = BranchWarehousing.objects.create(domestic_invoice=domestic_invoice,**data)
        ...
        #     }
        #     BranchWarehousing.objects.create(warehousing=warehousing,**product_data)
